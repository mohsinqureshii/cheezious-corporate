...
export const REFERENCE_COLLECTIONS: CollectionConfig[] = [
  reference({
    ...
    permissions: {
      read: 'timeline.manage',
      create: 'timeline.manage',
      update: 'timeline.manage',
      delete: 'timeline.manage',
      publish: 'timeline.manage',
    },
    label: 'Milestone',
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'date',
        group: 'content',
        help: 'Optional. Early milestones are often known only to the year.',
      },
      {
        name: 'headline',
        label: 'Headline',
  ...
  reference({
    ...
    permissions: {
      read: 'awards.manage',
      create: 'awards.manage',
      update: 'awards.manage',
      delete: 'awards.manage',
      publish: 'awards.manage',
    },
    label: 'Award',
    labelPlural: 'Awards',
    labelField: 'name',
    ...
    fields: [
      ...
      },
      {
        ...
        group: 'content',
        inList: true,
        help: 'The body that granted it. Only record awards actually received.',
      },
      {
        name: 'year',
        label: 'Year',
      ...
      { name: 'description', label: 'Description', type: 'textarea', max: 2000, group: 'content' },
      {
        ...
        max: 400,
        group: 'details',
        help: 'A public reference for the award, where one exists.',
      },
      {
        name: 'categoryId',
        label: 'Category',
  ...
  reference({
    ...
    permissions: {
      read: 'employeeStories.manage',
      create: 'employeeStories.manage',
      update: 'employeeStories.manage',
      delete: 'employeeStories.manage',
      publish: 'employeeStories.manage',
    },
    ...
    fields: [
      ...
      { name: 'quote', label: 'Pull quote', type: 'textarea', max: 1000, group: 'content' },
      {
        ...
        collection: 'people',
        group: 'details',
        help: 'Optional. A story can feature someone without a full profile.',
      },
      {
        name: 'personName',
        label: 'Name',
        ...
        group: 'details',
        inList: true,
        help: 'Only publish a colleague’s name and story with their consent.',
      },
  ...
  reference({
    ...
    permissions: {
      read: 'impact.read',
      create: 'impact.manage',
      update: 'impact.manage',
      delete: 'impact.manage',
      publish: 'impact.manage',
    },
    label: 'Impact metric',
    ...
    fields: [
      ...
      },
      {
        ...
        max: 80,
        group: 'content',
        help: 'Stable identifier used in blocks and reports. Do not change it once in use.',
      },
      {
        name: 'pillarId',
        label: 'Pillar',
        type: 'reference',
        collection: 'impact-pillars',
        group: 'content',
        inList: true,
      },
      { name: 'description', label: 'Description', type: 'textarea', max: 2000, group: 'content' },
      ...
      { name: 'suffix', label: 'Suffix', type: 'text', max: 20, group: 'details' },
      {
        ...
        max: 4000,
        group: 'details',
        help: 'Required before a metric is published: a number without a method is not a fact.',
      },
      {
        name: 'internalSource',
  ...
  taxonomy({
    ...
    labelPlural: 'Story categories',
    read: 'stories.read',
    manage: 'stories.update',
    shape: { summary: true },
  ...
  taxonomy({
    ...
    labelPlural: 'Press release categories',
    read: 'pressReleases.read',
    manage: 'pressReleases.update',
  ...
  taxonomy({
    ...
    labelPlural: 'Award categories',
    read: 'awards.manage',
    manage: 'awards.manage',
