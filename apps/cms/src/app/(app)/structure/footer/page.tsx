...
export default async function FooterPage() {
  ...
  const data = await cmsFetch<{ footers: FooterConfig[] }>('/api/cms/structure/footer', { cookie }).catch(
    () => null,
  );
  ...
  if (!data) {
    return (
      <>
        ...
        <div className="p-06">
          <ErrorState title="The footer could not be loaded" description="Managing the footer is restricted." />
        </div>
      </>
    );
  }
