...
export default async function NavigationPage() {
  ...
  const data = await cmsFetch<{ navigations: Navigation[] }>('/api/cms/structure/navigation', {
    cookie,
  }).catch(() => null);
      ...
      <>
        ...
        <div className="p-06">
          <ErrorState
            ...
            description="Managing navigation is restricted."
          />
        </div>
      </>
    );
  ...
  return (
    <>
      <PageHeader
        title="Navigation"
        description="The menus visitors use to find their way around."
      />
      <NavigationEditor
