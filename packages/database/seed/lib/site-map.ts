...
export const SITE_MAP: PageSeedSpec[] = [
    ...
    blocks: [
      ...
      },
      {
        ...
        data: {
          ...
          body: '<p>Placeholder copy. Replace with the approved description of what the company does and how it is organised.</p>',
          image: { assetId: 'PLACEHOLDER' },
          links: [
            { label: 'Explore Cheezious', pageId: 'REF:/company/about', opensInNewTab: false },
          ],
        },
      },
      {
      ...
      {
        key: 'EmployeeStoryFeature',
        data: { eyebrow: 'Career story', fallbackToLatest: true, tone: 'light' },
      },
      {
        key: 'ImpactPillars',
        data: {
      ...
      },
      {
        ...
        data: {
          ...
          tone: 'accent',
          primaryLink: {
            label: 'Partner with Cheezious',
            pageId: 'REF:/company/partners',
            opensInNewTab: false,
          },
        },
      },
  ...
  editorialPage(
    '/company/about',
    'About Cheezious',
    'What the company is, what it does and how it is organised.',
    {
      statement:
      ...
      sections: [
        {
          heading: 'What we do',
          body: 'Placeholder copy. Replace with the approved description of the business.',
        },
        {
          heading: 'How we are organised',
          body: 'Placeholder copy describing the operating structure.',
        },
      ],
      priority: 0.9,
      type: 'SECTION_INDEX',
  ...
  editorialPage(
    '/company/our-story',
    'Our Story',
    'Where the company started and how it has grown.',
    {
      extraBlocks: [
        { key: 'Timeline', data: { heading: 'Milestones', layout: 'vertical', showMedia: true } },
      ],
      type: 'EDITORIAL',
    },
  ),
    ...
    blocks: [
      {
        ...
        data: {
          ...
          standfirst: 'The company in figures.',
        },
      },
      {
        key: 'KPIGrid',
      ...
      {
        key: 'PakistanFootprint',
        data: { heading: 'Where we operate', showCityList: true, tone: 'muted' },
      },
      ...
      {
        key: 'ReportGrid',
        data: { heading: 'Related publications', limit: 3, columns: '3', tone: 'muted' },
      },
    ],
  },
  editorialPage(
    '/company/purpose',
    'Our Purpose',
    'Why the company exists and what it is working towards.',
  ),
  editorialPage(
    '/company/mission-vision',
    'Mission & Vision',
    'What we are building and how we intend to get there.',
  ),
  editorialPage('/company/values', 'Our Values', 'The standards we hold ourselves to.'),
  editorialPage(
    '/company/our-brand',
    'Our Brand',
    'What the Cheezious brand stands for, and how it is used.',
  ),
  {
    ...
    blocks: [
      {
        ...
        data: {
          eyebrow: 'Our company',
          headline: 'Leadership',
          standfirst: 'The people responsible for running the company day to day.',
        },
      },
    ...
    blocks: [
      {
        ...
        data: {
          ...
          standfirst: 'Our business footprint by region and city.',
        },
      },
      {
        key: 'PakistanFootprint',
        data: { showCityList: true, metrics: ['restaurants', 'teamMembers', 'firstOpening'] },
      },
      {
        key: 'StoryGrid',
        data: {
          heading: 'Stories from around the country',
          kinds: ['EXPANSION', 'STORY'],
          limit: 3,
          columns: '3',
          tone: 'muted',
        },
  ...
  }),
  {
    ...
    blocks: [
      { key: 'HeroMinimal', data: { eyebrow: 'Our company', headline: 'Awards & recognition' } },
      {
        key: 'RichText',
        data: {
          body: '<p>Awards are managed in the CMS. Only awards the company has actually received are listed.</p>',
        },
      },
    ],
  },
  ...
  // ===========================================================================
  {
    ...
    title: 'Our Business',
    summary:
      'Restaurants, supply chain, digital, technology and quality — the parts that make the company work.',
    type: 'SECTION_INDEX',
    priority: 0.8,
    blocks: [
      {
          ...
          pillars: [
            {
              ...
              description: 'Running restaurants to a consistent standard.',
              link: {
                label: 'Restaurant operations',
                pageId: 'REF:/company/business/restaurant-operations',
                opensInNewTab: false,
              },
            },
            {
              title: 'Supply Chain',
              description: 'Procurement, warehousing, cold chain and distribution.',
              link: {
                label: 'Supply chain',
                pageId: 'REF:/company/business/supply-chain',
                opensInNewTab: false,
              },
            },
            {
              title: 'Delivery & Digital',
              description: 'Ordering, delivery and the digital experience.',
              link: {
                label: 'Delivery & digital',
                pageId: 'REF:/company/business/delivery-digital',
                opensInNewTab: false,
              },
            },
            {
              title: 'Technology',
              description: 'The systems behind ordering and operations.',
              link: {
                label: 'Technology',
                pageId: 'REF:/company/business/technology',
                opensInNewTab: false,
              },
            },
            {
              title: 'Restaurant Development',
              description: 'Finding, designing and building restaurants.',
              link: {
                label: 'Restaurant development',
                pageId: 'REF:/company/business/restaurant-development',
                opensInNewTab: false,
              },
            },
            {
              title: 'Food & Quality',
              description: 'Food safety, quality systems and sourcing.',
              link: {
                label: 'Food & quality',
                pageId: 'REF:/company/food-quality',
                opensInNewTab: false,
              },
            },
          ],
      ...
      {
        key: 'StoryGrid',
        data: { heading: 'Business stories', kinds: ['STORY'], limit: 3, columns: '3' },
      },
    ],
  },
  editorialPage(
    '/company/business/restaurant-operations',
    'Restaurant Operations',
    'How restaurants are run, and to what standard.',
  ),
  editorialPage(
    '/company/business/restaurants',
    'Our Restaurants',
    'The restaurant estate and the formats we operate.',
  ),
  editorialPage(
    '/company/business/delivery-digital',
    'Delivery & Digital',
    'Ordering, delivery and the digital customer experience.',
  ),
  editorialPage(
    '/company/business/technology',
    'Technology',
    'The systems that support ordering, restaurants and delivery.',
    {
      statement:
      ...
      sections: [
        {
          ...
          body: 'Placeholder copy about the customer app and web ordering.',
        },
        {
          heading: 'Restaurant systems',
          body: 'Placeholder copy about point of sale and kitchen systems.',
        },
        {
          heading: 'Data and decisions',
          body: 'Placeholder copy about how data supports operational decisions.',
        },
      ],
    },
  ),
  editorialPage(
    '/company/business/supply-chain',
    'Supply Chain',
    'Procurement, warehousing, cold chain and distribution.',
    {
      extraBlocks: [
        {
          key: 'SupplierCTA',
          data: {
            ...
            primaryLink: {
              ...
              pageId: 'REF:/company/partners/supplier-registration',
              opensInNewTab: false,
            },
            tone: 'accent',
          },
  ...
  editorialPage(
    '/company/business/procurement',
    'Procurement',
    'How we buy, and what we expect from suppliers.',
  ),
  editorialPage(
    '/company/business/food-innovation',
    'Food Innovation',
    'How new products are developed and tested.',
  ),
  editorialPage(
    '/company/business/restaurant-development',
    'Restaurant Development',
    'Finding, designing and building restaurants.',
  ),
  editorialPage(
    '/company/business/real-estate',
    'Real Estate',
    'What we look for in a location, and how to propose one.',
    {
      extraBlocks: [
        {
          key: 'RealEstateCTA',
          data: {
            ...
            primaryLink: {
              ...
              pageId: 'REF:/company/partners/submit-property',
              opensInNewTab: false,
            },
            tone: 'accent',
          },
  ...
  editorialPage(
    '/company/business/growth-expansion',
    'Growth & Expansion',
    ...
    blocks: [
      {
        ...
        data: {
          ...
          headline: 'Food & Quality',
          standfirst: 'Food safety, quality systems, sourcing and the standards behind them.',
          tone: 'dark',
        },
      },
      {
        ...
        data: {
          ...
          pillars: [
            {
              title: 'Food safety',
              description: 'How food safety is managed across the business.',
              link: {
                label: 'Food safety',
                pageId: 'REF:/company/food-quality/food-safety',
                opensInNewTab: false,
              },
            },
            {
              title: 'Sourcing',
              description: 'How and where ingredients are sourced.',
              link: {
                label: 'Sourcing',
                pageId: 'REF:/company/food-quality/sourcing',
                opensInNewTab: false,
              },
            },
            {
              title: 'Supplier standards',
              description: 'What we require from suppliers.',
              link: {
                label: 'Supplier standards',
                pageId: 'REF:/company/food-quality/supplier-standards',
                opensInNewTab: false,
              },
            },
            {
              title: 'Restaurant standards',
              description: 'The standards every restaurant operates to.',
              link: {
                label: 'Restaurant standards',
                pageId: 'REF:/company/food-quality/restaurant-standards',
                opensInNewTab: false,
              },
            },
          ],
  ...
  editorialPage(
    '/company/food-quality/our-food',
    'Our Food',
    'What we make and how we think about it.',
  ),
  editorialPage('/company/food-quality/quality', 'Quality', 'The quality systems behind the food.'),
  editorialPage(
    '/company/food-quality/food-safety',
    'Food Safety',
    'How food safety is managed across the business.',
  ),
  {
  ...
  editorialPage(
    '/company/food-quality/supplier-standards',
    'Supplier Standards',
    'What we require from the suppliers we work with.',
  ),
  editorialPage(
    '/company/food-quality/restaurant-standards',
    'Restaurant Standards',
    'The standards every restaurant operates to.',
  ),
  editorialPage(
    '/company/food-quality/nutrition-allergens',
    'Nutrition & Allergens',
    ...
    blocks: [
      {
        ...
        data: {
          eyebrow: 'Our people',
          headline: 'The people who run it',
          standfirst: 'Restaurants, kitchens, warehouses, offices and the road in between.',
          tone: 'dark',
        },
      },
  ...
  editorialPage(
    '/company/people/learning-development',
    'Learning & Development',
    'How people learn and progress here.',
  ),
  editorialPage(
    '/company/people/life-at-cheezious',
    'Life at Cheezious',
    'What it is like to work here.',
  ),
  editorialPage('/company/people/recognition', 'Recognition', 'How we recognise good work.'),
  editorialPage(
    '/company/people/workplace',
    'Workplace',
    'The working environment and the standards behind it.',
  ),
  ...
  // ===========================================================================
  {
    ...
    title: 'Careers',
    summary:
      'Restaurant, corporate, technology, supply chain and early-career roles across Pakistan.',
    type: 'LANDING',
    priority: 0.9,
    ...
    blocks: [
      ...
      {
        key: 'JobCategories',
        data: { heading: 'Where you could work', showOpenCount: true, columns: '3' },
      },
      { key: 'JobSearch', data: { heading: 'Open roles', showFilters: true, pageSize: 10 } },
      {
        key: 'EmployeeStoryFeature',
        data: {
          heading: 'Career stories',
      ...
      },
      {
        ...
        data: {
          ...
          steps: [
            {
              title: 'Crew Member',
              description: 'Learning the operation from the floor up.',
              durationLabel: 'Year 1',
            },
            {
              title: 'Shift Manager',
              description: 'Running a shift and leading a team.',
              durationLabel: 'Years 2–3',
            },
            {
              title: 'Restaurant Manager',
              description: 'Accountable for a restaurant end to end.',
              durationLabel: 'Years 3–5',
            },
            {
              title: 'Area Manager',
              description: 'Supporting several restaurants and their managers.',
              durationLabel: 'Year 5+',
            },
          ],
        },
      },
  ...
  editorialPage('/careers/why-cheezious', 'Why Cheezious', 'What we offer, and what we ask.', {
    priority: 0.7,
  }),
  {
    ...
    blocks: [
      ...
      {
        key: 'JobSearch',
        data: { categoryId: 'REF:CAREER:RESTAURANT', showFilters: true, pageSize: 10 },
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        key: 'JobSearch',
        data: { categoryId: 'REF:CAREER:CORPORATE', showFilters: true, pageSize: 10 },
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        key: 'JobSearch',
        data: { categoryId: 'REF:CAREER:TECHNOLOGY', showFilters: true, pageSize: 10 },
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        key: 'JobSearch',
        data: { categoryId: 'REF:CAREER:SUPPLY_CHAIN', showFilters: true, pageSize: 10 },
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        key: 'JobSearch',
        data: { categoryId: 'REF:CAREER:EARLY_CAREERS', showFilters: true, pageSize: 10 },
      },
    ],
  },
  editorialPage(
    '/careers/internships',
    'Internships',
    'Internship opportunities across the business.',
  ),
            ...
            items: [
              {
                ...
                answer: '<p>Placeholder answer. Replace with the approved response.</p>',
              },
              {
                question: 'Will I hear back if I am unsuccessful?',
                answer: '<p>Placeholder answer. Replace with the approved response.</p>',
              },
            ],
          },
    ...
    blocks: [
      {
        ...
        data: {
          eyebrow: 'Careers',
          headline: 'Open roles',
          standfirst: 'Search and filter every role we are currently hiring for.',
        },
      },
    ...
    blocks: [
      {
        ...
        data: {
          eyebrow: 'Impact',
          headline: 'Our Impact',
          standfirst: 'What we are working on, and the measures we hold ourselves to.',
          tone: 'dark',
        },
      },
  ...
  editorialPage(
    ...
    'Community',
    'Working with the communities we operate in.',
  ),
  ...
  editorialPage(
    '/company/impact/packaging-waste',
    'Packaging & Waste',
    'Packaging materials and waste.',
  ),
  editorialPage(
    '/company/impact/responsible-sourcing',
    ...
    blocks: [
      {
        ...
        data: {
          eyebrow: 'Partners',
          headline: 'Partner with Cheezious',
          standfirst: 'Suppliers, property partners and institutions.',
          tone: 'dark',
        },
      },
      {
        ...
        data: {
          heading: 'Suppliers',
          body: 'Ingredients, packaging, equipment, logistics and services.',
          primaryLink: {
            label: 'Register as a supplier',
            pageId: 'REF:/company/partners/supplier-registration',
            opensInNewTab: false,
      ...
      },
      {
        ...
        data: {
          heading: 'Real estate',
          body: 'Propose a location for a new restaurant.',
          primaryLink: {
            label: 'Submit a property',
            pageId: 'REF:/company/partners/submit-property',
            opensInNewTab: false,
      ...
      },
      {
        ...
        data: {
          ...
          body: 'Universities, banks, technology companies, developers and community organisations.',
          primaryLink: {
            label: 'Make an enquiry',
            pageId: 'REF:/company/partners/institutional',
            opensInNewTab: false,
          },
        },
      },
  ...
  editorialPage(
    ...
    'Suppliers',
    'How we work with suppliers, and what we look for.',
    {
      extraBlocks: [
        {
          key: 'SupplierCTA',
    ...
    blocks: [
      {
        ...
        data: {
          eyebrow: 'Partners',
          headline: 'Become a Cheezious supplier',
          standfirst:
            'Tell us about your company and what you supply. Our procurement team reviews every submission.',
        },
      },
    ...
    blocks: [
      {
        ...
        data: {
          eyebrow: 'Partners',
          headline: 'Have a location for Cheezious?',
          standfirst: 'Tell us about the property. Our expansion team reviews every submission.',
        },
      },
  ...
  },
  {
    ...
    blocks: [
      { key: 'HeroMinimal', data: { eyebrow: 'Partners', headline: 'Business enquiries' } },
      {
        ...
        data: {
          entries: [
            { title: 'Corporate enquiries', description: 'General questions about the company.' },
          ],
        },
      },
    ],
    ...
    blocks: [
      {
        ...
        data: {
          ...
          standfirst:
            'How the company is governed, and the standards that apply across the business.',
        },
      },
      {
        key: 'RichText',
        data: {
          body: '<p>Governance content is published only once it has been approved. Sections showing no content are awaiting approved text.</p>',
        },
      },
      {
        key: 'PolicyList',
        data: { heading: 'Policies', showLastUpdated: true, showDownload: true, tone: 'muted' },
      },
    ],
  },
  editorialPage(
    '/company/governance/ethics-integrity',
    'Ethics & Integrity',
    'The standards we hold ourselves to.',
    { priority: 0.5 },
  ),
  editorialPage(
    '/company/governance/code-of-conduct',
    'Code of Conduct',
    'How we expect people to behave.',
    { priority: 0.5 },
  ),
  editorialPage(
    '/company/governance/supplier-code',
  ...
  editorialPage('/company/governance/speak-up', 'Speak Up', 'How to raise a concern.', {
    priority: 0.5,
  }),
  editorialPage('/company/governance/privacy', 'Privacy', 'How we handle personal information.', {
    priority: 0.5,
  }),
  editorialPage(
    '/company/governance/information-security',
    ...
    blocks: [
      {
        ...
        data: {
          eyebrow: 'Newsroom',
          headline: 'Newsroom',
          standfirst: 'Company news, press releases and stories.',
        },
      },
      ...
      { key: 'NewsGrid', data: { heading: 'Latest news', limit: 6, columns: '3' } },
      {
        ...
        data: { heading: 'Press releases', limit: 5, showYearFilter: false, tone: 'muted' },
      },
      {
        key: 'CTAEditorial',
        data: {
          heading: 'Media centre',
          body: 'Fact sheets, brand assets, leadership photography and media contacts.',
          primaryLink: {
            label: 'Visit the media centre',
            pageId: 'REF:/company/newsroom/media-center',
            opensInNewTab: false,
          },
        },
      },
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        key: 'RichText',
        data: { body: '<p>Third-party coverage is listed here as it is published.</p>' },
      },
    ],
  },
  {
    ...
    title: 'Media Center',
    summary:
      'Everything a journalist needs: fact sheet, boilerplate, leadership biographies, photography and contacts.',
    type: 'LANDING',
    priority: 0.7,
    blocks: [
      {
        ...
        data: {
          ...
          standfirst: 'Company information, approved assets and media contacts.',
        },
      },
      {
        key: 'RichText',
        data: {
          heading: 'About Cheezious',
          body: '<p>The approved corporate boilerplate is managed in the CMS and appears here.</p>',
        },
      },
      {
        key: 'MediaDownloadGrid',
        data: { heading: 'Brand assets', showFileMeta: true, columns: '3', tone: 'muted' },
      },
      {
        key: 'LeadershipGrid',
        data: { heading: 'Leadership', columns: '4', linkToProfiles: true },
      },
      {
        key: 'ContactDirectory',
        data: {
          heading: 'Media contacts',
          entries: [{ title: 'Press office', description: 'For media enquiries.' }],
        },
      },
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        key: 'ContactDirectory',
        data: { entries: [{ title: 'Press office', description: 'For media enquiries.' }] },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        data: {
          heading: 'Boilerplate',
          body: '<p>The approved corporate boilerplate is managed in the CMS.</p>',
        },
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        data: {
          eyebrow: 'Resources',
          headline: 'Corporate resources',
          standfirst: 'Company publications, reports and policies.',
        },
      },
      {
        key: 'DocumentLibrary',
        data: { showFilters: true, filters: ['year', 'type', 'language'], layout: 'rows' },
      },
    ],
  },
  {
  ...
  editorialPage(
    '/company/resources/company-profile',
    'Company Profile',
  ...
  // ===========================================================================
  {
    ...
    title: 'Contact',
    summary:
      'Routed contact points for customers, media, careers, suppliers and property partners.',
    type: 'CONTACT',
    priority: 0.7,
    blocks: [
      {
        ...
        data: {
          eyebrow: 'Contact',
          headline: 'Contact Cheezious',
          standfirst: 'Choose the route that fits your enquiry so it reaches the right team.',
        },
      },
      {
        key: 'ContactDirectory',
        data: {
          entries: [
            {
              title: 'Customer care',
              description: 'Questions or feedback about a visit or an order.',
            },
      ...
      {
        key: 'FormBlock',
        data: { formKey: 'CONTACT', width: 'narrow', heading: 'Send us a message' },
      },
    ],
  },
  {
    path: '/company/contact/customer',
    title: 'Customer Care',
    summary: 'Questions or feedback about a restaurant visit or an order.',
    type: 'CONTACT',
    blocks: [
      { key: 'HeroMinimal', data: { eyebrow: 'Contact', headline: 'Customer care' } },
      { key: 'FormBlock', data: { formKey: 'CONTACT', width: 'narrow' } },
    ],
  },
  {
    path: '/company/contact/media',
    title: 'Media Enquiries',
    summary: 'For journalists and media organisations.',
    type: 'CONTACT',
    blocks: [
      { key: 'HeroMinimal', data: { eyebrow: 'Contact', headline: 'Media enquiries' } },
      { key: 'ContactDirectory', data: { entries: [{ title: 'Press office' }] } },
      { key: 'FormBlock', data: { formKey: 'CONTACT', width: 'narrow' } },
    ],
  },
  {
    path: '/company/contact/careers',
    title: 'Careers Enquiries',
    summary: 'Questions about applying or a live application.',
    type: 'CONTACT',
    blocks: [
      { key: 'HeroMinimal', data: { eyebrow: 'Contact', headline: 'Careers enquiries' } },
      { key: 'FormBlock', data: { formKey: 'CONTACT', width: 'narrow' } },
    ],
  },
  {
    path: '/company/contact/suppliers',
    title: 'Supplier Enquiries',
    summary: 'Questions about supplying Cheezious.',
    type: 'CONTACT',
    blocks: [
      { key: 'HeroMinimal', data: { eyebrow: 'Contact', headline: 'Supplier enquiries' } },
      { key: 'FormBlock', data: { formKey: 'CONTACT', width: 'narrow' } },
    ],
  },
  {
    path: '/company/contact/real-estate',
    title: 'Real Estate Enquiries',
    summary: 'Questions about proposing a location.',
    type: 'CONTACT',
    blocks: [
      { key: 'HeroMinimal', data: { eyebrow: 'Contact', headline: 'Real estate enquiries' } },
      { key: 'FormBlock', data: { formKey: 'CONTACT', width: 'narrow' } },
    ],
  },
  ...
  // ===========================================================================
  {
    ...
    blocks: [
      {
        key: 'HeroMinimal',
        data: { eyebrow: 'Search', headline: 'Search', showBreadcrumb: false },
      },
    ],
  },
];
