...
export const PERMISSION_GROUPS: Array<{ key: string; label: string; permissions: Permission[] }> = [
  ...
  },
  {
    ...
    permissions: ['timeline.manage', 'awards.manage', 'locations.manage'],
  },
  {
    key: 'careers',
    label: 'Careers',
  ...
  },
  {
    key: 'forms',
    label: 'Forms & contact',
    permissions: ['forms.read', 'forms.manage', 'forms.export', 'contact.read', 'contact.manage'],
  },
  {
    key: 'media',
    label: 'Media',
  ...
  { key: 'structure', label: 'Structure', permissions: ['navigation.manage', 'redirects.manage'] },
  {
    key: 'localization',
    label: 'Localization',
    permissions: ['localization.read', 'localization.manage'],
  },
  {
    key: 'system',
    label: 'System',
